...
export function MemberReportView({ userId, userName, projectFilter, hideBackButton = false }: MemberReportViewProps) {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            try {
                ...
                const reportUrl = `/api/reports/member?userId=${encodeURIComponent(userId)}${projectFilter ? `&projectKey=${projectFilter}` : ''}&days=30`;
